...
final class CreateApiLogTable extends AbstractMigration
{
    public function change(): void
    {
        $environment = $this->input->getParameterOption('-e');
        if ("api_log" === $environment) {
            ...
            $this->execute("CREATE TABLE IF NOT EXISTS `apilog` (
                  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Ид записи события',
                  ...
                  `request` json DEFAULT NULL COMMENT 'Запрос в формате json',
                  `response` json DEFAULT NULL COMMENT 'Ответ в формате json',
                  `backtrace` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Бэктрейс вызова события',
